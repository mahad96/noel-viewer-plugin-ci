...
if ($mform->is_cancelled()) {
    ...
    //  ====================== Added for handeling image upload: Start ====================== 
    // receiving the image and updating in db.   // amir 25.04.2019
    /*echo "<pre>";
    print_r($cm);die;*/
   ...
   /* echo "<pre>";
    ...
    // echo $coursemodulek;die;

   /* echo "INSERT INTO mdl_medicalimageviewer_images(itemid, course, coursemodule, image,  time_created) VALUES($idnumberk, $coursek, $coursemodulek,'$imagekk', $time)";die;*/
...
//  ====================== Added for handeling image upload: End ====================== 
